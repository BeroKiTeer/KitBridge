...
func (p *STRequest) fastWriteField15(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetMockCost() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "mockCost", thrift.STRING, 15)
...
func (p *STRequest) fastWriteField16(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetFramework() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "framework", thrift.STRING, 16)
...
func (p *STRequest) fastWriteField17(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetUserId() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "userId", thrift.STRING, 17)
...
func (p *STRequest) field15Length() int {
	l := 0
	if p.IsSetMockCost() {
		l += bthrift.Binary.FieldBeginLength("mockCost", thrift.STRING, 15)
...
func (p *STRequest) field16Length() int {
	l := 0
	if p.IsSetFramework() {
		l += bthrift.Binary.FieldBeginLength("framework", thrift.STRING, 16)
...
func (p *STRequest) field17Length() int {
	l := 0
	if p.IsSetUserId() {
		l += bthrift.Binary.FieldBeginLength("userId", thrift.STRING, 17)
...
func (p *STResponse) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetFramework() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "framework", thrift.STRING, 4)
		offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, *p.Framework)
...
func (p *STResponse) field4Length() int {
	l := 0
	if p.IsSetFramework() {
		l += bthrift.Binary.FieldBeginLength("framework", thrift.STRING, 4)
		l += bthrift.Binary.StringLengthNocopy(*p.Framework)
